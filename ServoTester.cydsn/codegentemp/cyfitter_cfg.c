...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_C00), 0x80000002u);

	/* CYDEV_CLK_DIVIDER_A01 Starting address: CYDEV_CLK_DIVIDER_A01 */
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A01), 0x000000EFu);
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x00000303u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x00980000u);
		...
		CY_SET_REG32((void *)(CYREG_TCPWM_CNT1_TR_CTRL0), 0x00010010u);
